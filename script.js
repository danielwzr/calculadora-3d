...
function calcularCusto() {
  ...
  document.getElementById("resultado").innerHTML =
    `🧵 Filamento: <b>R$ ${custoFilamento.toFixed(2)}</b><br><span class="detalhe">(${pesoGasto}g de um filamento que custa R$ ${valorFilamento}/kg)</span><br><br>
         ...
         📦 Sugestões de filamento custo-benefício: <br><br><a href="https://s.shopee.com.br/8fIebSZ44G" target="_blank">Voolt3D</a> <br><br><a href="https://s.shopee.com.br/2g1RSPASlm" target="_blank">MasterPrint</a>
  `;
